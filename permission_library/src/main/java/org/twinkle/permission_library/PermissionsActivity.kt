...
class PermissionsActivity : Activity() {
    private var allPermissions: java.util.ArrayList<String?>? = null
    private var deniedPermissions: java.util.ArrayList<String?>? = null
    private var noRationaleList: java.util.ArrayList<String?>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        allPermissions =
            intent.getSerializableExtra(EXTRA_PERMISSIONS) as java.util.ArrayList<String?>?
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent) {
        if (requestCode == RC_SETTINGS && permissionHandler != null) {
            Permissions.check(
                this, true, toArray(allPermissions), null, options,
                permissionHandler!!
            )
        }
    ...
    private fun toArray(arrayList: java.util.ArrayList<String?>?): Array<String?> {
    ...
    companion object {
        ...
        const val EXTRA_PERMISSIONS: String = "permissions"
        const val EXTRA_RATIONALE: String = "rationale"
